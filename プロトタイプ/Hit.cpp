...
戻り値：二点間の距離
******************************************************/
double cHit::TwoPoint(double _x1, double _y1, double _x2, double _y2) {
...
/*****************************************************
名前　：bool Rect(double _x1, double _y1, double _w1, double _h1,
...
******************************************************/
bool cHit::Rect(double _x1, double _y1, double _w1, double _h1,
	double _x2, double _y2, double _w2, double _h2) {

	//20191127時点、計算にミスがあります
...
bool cHit::RectOnClick(double _x1, double _y1, double _x2, double _y2) {
